    ...
    <div className="bg-gradient-to-r from-blue-100 to-gray-100 rounded-2xl p-8 text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-gray-700 mb-6">
          Help us maintain and improve our free shoe identifier by supporting us.
          Your contribution helps keep this tool free for all sneaker and footwear enthusiasts! 👟
        </p>
        <a
